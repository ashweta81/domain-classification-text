...
print('The accuracy of the SVM model is', lsvm_accuracy)
...
X_test = vectorizer.transform(all_text).toarray()
...
print('The accuracy for LR is', log_accuracy_2)

#Naive Bayes
y_pred_nb = nb.predict(X_test)
nb_accuracy_2 = accuracy_score(y_test, y_pred_nb)

print('The accuracy for LR is', nb_accuracy_2)

#SVM
y_pred_lsvm = lsvm.predict(X_test)
lsvm_accuracy_2 = accuracy_score(y_test, y_pred_lsvm)

print('The accuracy for LR is', lsvm_accuracy_2)
...
print(np.argmax(coherence_value_list))
